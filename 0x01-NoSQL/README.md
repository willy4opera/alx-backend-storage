...
The content of this project are tasks for learning to use the MongoDB NoSQL database application.

## Tasks Completed

+ [x] 0. **List all databases**<br/>[0-list_databases](0-list_databases) contains a MongoDB script that shows all databases in MongoDB.
